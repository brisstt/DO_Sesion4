...
#print(api.dataset_list(search='jatinthakur706'))#solo para buscar los diferentes datasets que existen
#nombre data set 7/ nombre del archivo , nombre del archivo xd
api.dataset_download_file('jatinthakur706/most-watched-netflix-original-shows-tv-time', 'imdb.csv',path='dataset')